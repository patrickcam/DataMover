...
namespace DataMover
{
	...
	public static partial class DataMover
	{
		...
		{
			TraceLog.WriteConsole($"Parsing command file [{fileName}]");
			...
			switch (cmd.ToLower())
			{
				case "import":
					...
					break;
				case "export":
					command = new TableCommandExportToBinary();
					break;
				case "exporttoexcel":
					command = new TableCommandExportToExcel();
					break;
				case "exporttohtml":
					command = new TableCommandExportToHtml();
					break;
				case "delete":
